...
export default function DriverDashboard({ metrics, latest }) {
    return (
        <DriverLayout
            header={
                <div className="flex items-center justify-between gap-4">
                    <div>
                        ...
                        <div className="mt-1 text-sm text-gray-500">
                            Motorista: seus custos e seu controle.
                        </div>
                    </div>
                    <Link
                ...
                <div className="mx-auto max-w-7xl space-y-8 px-4 sm:px-6 lg:px-8">
                    <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        <StatCard
                            ...
                            subtitle="Somatório dos seus custos do dia"
                        />
                        <StatCard
                            title="Total do mês"
                            value={formatMoneyFromCents(
                            ...
                            subtitle="Somatório dos seus custos do mês"
                        />
                        <StatCard
                            title="Lançamentos no mês"
                            value={metrics.month_count}
                            subtitle="Quantidade de lançamentos no mês"
                        />
                    </div>
